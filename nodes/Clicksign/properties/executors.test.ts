...
describe('executors', () => {
  it('should contain expected resources', () => {
    ...
    expect(Object.keys(resourceOperationsFunctions).length).toEqual(9);
  });
  ...
  it('should not contain unexpected resources or operations', () => {
    ...
    expect(Object.keys(resourceOperationsFunctions.requirement).length).toBe(7);
    ...
    expect(Object.keys(resourceOperationsFunctions.watcher).length).toBe(4);
  });
});
